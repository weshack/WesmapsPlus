...
Schedule = (function() {
  ...
  function Schedule(courseData, $wrapper) {
    var $newDay, $rel, d, dayAbbrev, _i, _len, _ref,
      _this = this;
    this.lowlightCourses = function() {
      return Schedule.prototype.lowlightCourses.apply(_this, arguments);
    };
    this.highlightCourse = function(course) {
      return Schedule.prototype.highlightCourse.apply(_this, arguments);
    };
  ...
  Schedule.prototype.draw = function() {
    ...
    for (course in _ref1) {
      ...
      if (this.colors[course]) {
        ...
        this.colors[course] = thisColor = Schedule.possColors[Math.floor(Math.random() * 10)];
      }
